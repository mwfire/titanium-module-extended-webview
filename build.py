...
module_defaults = {
	'description':'Extended Webview',
	'author': 'Martin Wildfeuer',
	'license' : 'Licensed under the Apache License, Version 2.0',
	'copyright' : 'Copyright (c) %s by mwfire web development' % str(date.today().year),
}
module_license_default = ""
...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','de.mwfire.extwebview.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','DeMwfireExtwebviewModuleAssets.m')
